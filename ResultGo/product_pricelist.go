...
pool.Pricelist().Methods().GetDefaultCurrencyId().DeclareMethod(
`GetDefaultCurrencyId` ,
func (rs pool.PricelistSet){
  /*def _get_default_currency_id(self):
        return self.env.user.company_id.currency_id.id

    */})
pool.Pricelist().Methods().GetDefaultItemIds().DeclareMethod(
`GetDefaultItemIds` ,
func (rs pool.PricelistSet){
...
pool.Pricelist().Methods().NameGet().DeclareMethod(
`NameGet` ,
func (rs pool.PricelistSet){
  //@api.multi
  /*def name_get(self):
    ...
    */})
pool.Pricelist().Methods().NameSearch().DeclareMethod(
`NameSearch` ,
func (rs pool.PricelistSet , args struct{Args interface{}
Operator interface{}
Limit interface{}
}){
  //@api.model
  /*def name_search(self, name, args=None, operator='ilike', limit=100):
    ...
    */})
pool.Pricelist().Methods().ComputePriceRuleMulti().DeclareMethod(
`ComputePriceRuleMulti` ,
func (rs pool.PricelistSet , args struct{ProductsQtyPartner interface{}
Date interface{}
UomId interface{}
}){
  /*def _compute_price_rule_multi(self, products_qty_partner, date=False, uom_id=False):
    ...
    */})
pool.Pricelist().Methods().ComputePriceRule().DeclareMethod(
`ComputePriceRule` ,
func (rs pool.PricelistSet , args struct{ProductsQtyPartner interface{}
Date interface{}
UomId interface{}
  ...
  /*def _compute_price_rule(self, products_qty_partner, date=False, uom_id=False):
    ...
    */})
pool.Pricelist().Methods().GetProductsPrice().DeclareMethod(
`GetProductsPrice` ,
func (rs pool.PricelistSet , args struct{Products interface{}
...
UomId interface{}
  ...
  /*def get_products_price(self, products, quantities, partners, date=False, uom_id=False):
    ...
    */})
pool.Pricelist().Methods().GetProductPrice().DeclareMethod(
`GetProductPrice` ,
func (rs pool.PricelistSet , args struct{Product interface{}
Quantity interface{}
Partner interface{}
Date interface{}
UomId interface{}
  ...
  /*def get_product_price(self, product, quantity, partner, date=False, uom_id=False):
    ...
    */})
pool.Pricelist().Methods().GetProductPriceRule().DeclareMethod(
`GetProductPriceRule` ,
func (rs pool.PricelistSet , args struct{Product interface{}
Quantity interface{}
Partner interface{}
...
UomId interface{}
  ...
  /*def get_product_price_rule(self, product, quantity, partner, date=False, uom_id=False):
    ...
    */})
pool.Pricelist().Methods().PriceRuleGetMulti().DeclareMethod(
`PriceRuleGetMulti` ,
func (rs pool.PricelistSet , args struct{Pricelist interface{}
ProductsByQtyByPartner interface{}
  ...
  /*def _price_rule_get_multi(self, pricelist, products_by_qty_by_partner):
    ...
    */})
pool.Pricelist().Methods().PriceGet().DeclareMethod(
`PriceGet` ,
func (rs pool.PricelistSet , args struct{ProdId interface{}
Partner interface{}
}){
  //@api.multi
...
pool.Pricelist().Methods().PriceRuleGetMulti().DeclareMethod(
`PriceRuleGetMulti` ,
func (rs pool.PricelistSet , args struct{ProductsByQtyByPartner interface{}
}){
  //@api.multi
  /*def price_rule_get_multi(self, products_by_qty_by_partner):
    ...
    */})
pool.Pricelist().Methods().PriceRuleGet().DeclareMethod(
`PriceRuleGet` ,
func (rs pool.PricelistSet , args struct{ProdId interface{}
Partner interface{}
}){
  ...
  /*def price_rule_get(self, prod_id, qty, partner=None):
    ...
    */})
pool.Pricelist().Methods().PriceGetMulti().DeclareMethod(
`PriceGetMulti` ,
func (rs pool.PricelistSet , args struct{Pricelist interface{}
ProductsByQtyByPartner interface{}
}){
  ...
  /*def _price_get_multi(self, pricelist, products_by_qty_by_partner):
    ...
    */})
pool.Pricelist().Methods().GetPartnerPricelist().DeclareMethod(
`GetPartnerPricelist` ,
func (rs pool.PricelistSet , args struct{PartnerId interface{}
CompanyId interface{}
}){
...
pool.PricelistItem().AddCharField("Name", models.StringFieldParams{String :"Name", Compute: "GetPricelistItemNamePrice" ,Help :"Explicit rule name for this pricelist line." ,Help :"Explicit rule name for this pricelist line."})
pool.PricelistItem().AddCharField("Price", models.StringFieldParams{String :"Price", Compute: "GetPricelistItemNamePrice" ,Help :"Explicit rule name for this pricelist line." ,Help :"Explicit rule name for this pricelist line."})
pool.PricelistItem().Methods().CheckRecursion().DeclareMethod(
`CheckRecursion` ,
func (rs pool.PricelistItemSet){
  ...
  /*def _check_recursion(self):
    ...
    */})
pool.PricelistItem().Methods().CheckMargin().DeclareMethod(
`CheckMargin` ,
func (rs pool.PricelistItemSet){
  ...
  /*def _check_margin(self):
    ...
    */})
pool.PricelistItem().Methods().GetPricelistItemNamePrice().DeclareMethod(
...
func (rs pool.PricelistItemSet){
  /*def _get_pricelist_item_name_price(self):
    ...
    */})
pool.PricelistItem().Methods().OnchangeAppliedOn().DeclareMethod(
`OnchangeAppliedOn` ,
func (rs pool.PricelistItemSet){
  ...
  /*def _onchange_applied_on(self):
    ...
    */})
pool.PricelistItem().Methods().OnchangeComputePrice().DeclareMethod(

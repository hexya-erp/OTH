...
func (rs pool.PricelistSet , products_qty_partner , date=False , uom_id=False){
/*_compute_price_rule_multi(self, products_qty_partner, date=False, uom_id=False):
...
func (rs pool.PricelistSet){
/*@api.multi
    _compute_price_rule(self, products_qty_partner, date=False, uom_id=False):
...
`GetProductsPrice` ,
func (rs pool.PricelistSet , products , quantities , partners , date=False , uom_id=False){
/*get_products_price(self, products, quantities, partners, date=False, uom_id=False):
...
`GetProductPrice` ,
func (rs pool.PricelistSet , product , quantity , partner , date=False , uom_id=False){
/*get_product_price(self, product, quantity, partner, date=False, uom_id=False):
...
`GetProductPriceRule` ,
func (rs pool.PricelistSet , product , quantity , partner , date=False , uom_id=False){
/*get_product_price_rule(self, product, quantity, partner, date=False, uom_id=False):
...
func (rs pool.PricelistSet){
/*@api.model
    _price_rule_get_multi(self, pricelist, products_by_qty_by_partner):
...
func (rs pool.PricelistSet){
/*@api.multi
    price_get(self, prod_id, qty, partner=None):
...
func (rs pool.PricelistSet){
/*@api.model
    _price_get_multi(self, pricelist, products_by_qty_by_partner):
...
`GetPartnerPricelist` ,
func (rs pool.PricelistSet , partner_id , company_id=None){
/*_get_partner_pricelist(self, partner_id, company_id=None):
...
`CheckRecursion` ,
func (rs pool.PricelistItemSet ,base_pricelist_id , 'pricelist_id' , 'base'){
/*@api.constrains('base_pricelist_id', 'pricelist_id', 'base')
    _check_recursion(self):
...
`CheckMargin` ,
func (rs pool.PricelistItemSet ,price_min_margin interface{} , 'price_max_margin'){
...
`OnchangeAppliedOn` ,
func (rs pool.PricelistItemSet){
/*_get_pricelist_item_name_price(self):
        if self.categ_id:
...
func (rs pool.PricelistItemSet ,applied_on){
/*@api.onchange('applied_on')
    _onchange_applied_on(self):

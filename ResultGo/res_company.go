...
pool.ResCompany().Methods().Create().DeclareMethod(
`Create` ,
func (rs pool.ResCompanySet , args struct{}){
  //@api.model
  /*def create(self, vals):
    ...
    */})
pool.ResCompany().Methods().Write().DeclareMethod(
`Write` ,
func (rs pool.ResCompanySet , args struct{Values interface{}
}){
  //@api.multi

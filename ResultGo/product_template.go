...
pool.ProductTemplate().AddMany2OneField("CategId",models.ForeignKeyFieldParams{String :"Internal Category" , RelationModel: pool.ProductCategory(), Default : pool.ProductTemplate.GetDefaultCategoryId()})
pool.ProductTemplate().AddMany2OneField("CurrencyId",models.ForeignKeyFieldParams{String :"Currency" , RelationModel: pool.ResCurrency()})
pool.ProductTemplate().AddFloatField("Price", models.FloatFieldParams{String :"Price", Compute: "ComputeTemplatePrice"})
...
pool.ProductTemplate().AddFloatField("StandardPrice", models.FloatFieldParams{String :"Cost", Compute: "ComputeStandardPrice"})
pool.ProductTemplate().AddFloatField("Volume", models.FloatFieldParams{String :"Volume", Compute: "ComputeVolume" ,Help :"The volume in m3., store"})
pool.ProductTemplate().AddFloatField("Weight", models.FloatFieldParams{String :"Weight", Compute: "ComputeWeight"})
...
pool.ProductTemplate().AddMany2OneField("PricelistId",models.ForeignKeyFieldParams{String :"Pricelist" , RelationModel: pool.ProductPricelist(), Stored: false , Help :"'Technical field. Used for searching on pricelists, not stored in database.'"})
pool.ProductTemplate().AddMany2OneField("UomId",models.ForeignKeyFieldParams{String :"Unit of Measure" , RelationModel: pool.ProductUom(), Default : pool.ProductTemplate.GetDefaultUomId(), Required: true , Help :"Default Unit of Measure used for all stock operation."})
pool.ProductTemplate().AddMany2OneField("UomPoId",models.ForeignKeyFieldParams{String :"Purchase Unit of Measure" , RelationModel: pool.ProductUom(), Default : pool.ProductTemplate.GetDefaultUomId(), Required: true , Help :"Default Unit of Measure used for purchase orders. It must be in the same category than the default unit of measure."})
pool.ProductTemplate().AddMany2OneField("CompanyId",models.ForeignKeyFieldParams{String :"Company" , RelationModel: pool.ResCompany(), Default: func(models.Environment, models.FieldMap) interface{} {return lambda self: self.env['res.company']._company_default_get}})
pool.ProductTemplate().AddOne2ManyField("PackagingIds", models.ReverseFieldParams{String :"Logistical Units" ,RelationModel : pool.ProductPackaging() ,ReverseFK : "ProductTmplId"})
pool.ProductTemplate().AddOne2ManyField("SellerIds", models.ReverseFieldParams{String :"Vendors')" ,RelationModel : pool.ProductSupplierinfo() ,ReverseFK : "ProductTmplId"})
...
pool.ProductTemplate().AddOne2ManyField("AttributeLineIds", models.ReverseFieldParams{String :"Product Attributes')" ,RelationModel : pool.ProductAttributeLine() ,ReverseFK : "ProductTmplId"})
pool.ProductTemplate().AddOne2ManyField("ProductVariantIds", models.ReverseFieldParams{String :"Products" ,RelationModel : pool.ProductProduct() ,ReverseFK : "ProductTmplId"})
...
pool.ProductTemplate().AddIntegerField("ProductVariantCount", models.SimpleFieldParams{String :"# Product Variants", Compute : pool.ComputeProductVariantCount()})
pool.ProductTemplate().AddCharField("Barcode", models.StringFieldParams{String :"Barcode"})
pool.ProductTemplate().AddCharField("DefaultCode", models.StringFieldParams{String :"Internal Reference", Compute: "ComputeDefaultCode"})
pool.ProductTemplate().AddOne2ManyField("ItemIds", models.ReverseFieldParams{String :"Pricelist Items')" ,RelationModel : pool.ProductPricelistItem() ,ReverseFK : "ProductTmplId"})
...
func (rs pool.ProductTemplateSet){
  ...
  /*def _compute_template_price(self):
    ...
    */})
pool.ProductTemplate().Methods().SetTemplatePrice().DeclareMethod(
`SetTemplatePrice` ,
func (rs pool.ProductTemplateSet){
  //@api.multi
...
func (rs pool.ProductTemplateSet){
  ...
  /*def _compute_standard_price(self):
    ...
    */})
pool.ProductTemplate().Methods().SetStandardPrice().DeclareMethod(
`SetStandardPrice` ,
func (rs pool.ProductTemplateSet){
  //@api.one
...
func (rs pool.ProductTemplateSet){
  ...
  /*def _compute_volume(self):
    ...
    */})
pool.ProductTemplate().Methods().SetVolume().DeclareMethod(
`SetVolume` ,
func (rs pool.ProductTemplateSet){
  //@api.one
...
func (rs pool.ProductTemplateSet){
  ...
  /*def _compute_weight(self):
    ...
    */})
pool.ProductTemplate().Methods().SetWeight().DeclareMethod(
`SetWeight` ,
func (rs pool.ProductTemplateSet){
  //@api.one
...
func (rs pool.ProductTemplateSet){
  ...
  /*def _compute_default_code(self):
    ...
    */})
pool.ProductTemplate().Methods().SetDefaultCode().DeclareMethod(
`SetDefaultCode` ,
func (rs pool.ProductTemplateSet){
  //@api.one
